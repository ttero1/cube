...
/*   Updated: 2025/02/03 10:38:28 by ttero            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* init_start.c */
void				set_player_position(t_game *game, int x, \
							int y, double angle);
...
int					process_content(char *line, t_game *game, int *row,
						int *map);
...
double				calc_y_distance2(t_raycast *raycast,
						double angle);
double				calc_x_distance2(t_raycast *raycast,
						double angle);
